...
Resumable Incident Response Agent Runtime

## Portfolio / Application Summary

Built a Python incident-response agent runtime focused on harness reliability rather than demo
...
- Built a verifier-driven Python incident-response runtime with typed tools, verifiers,
  append-only JSONL transcripts, and checkpoint-driven resumability instead of prompt-only
  orchestration.
